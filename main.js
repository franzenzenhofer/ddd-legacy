...
(function() {
  var Tap, _DEBUG_, _game_won_, _level_, createDot, createEndDot, createFixedDot, d, dot, drawDot, end_dot, gravity, init, isDotOutOfBounds, mc, randomInt, removeDot, restart, setLevelCounter, setWorldColor, two, user_dots, world;
